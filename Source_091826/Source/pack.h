...
struct PlayerPack {
	...
	uint8_t pSplLvl[46]; // Should be MAX_SPELLS but set to 37 to make save games compatible
	uint64_t pMemSpells;
...
//void PackPlayer(PlayerPack *pPack, const Player &player, bool manashield, bool dmgreduct, bool ethershield, bool hlthregn, bool manaregn, bool netSync);
