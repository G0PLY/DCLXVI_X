...
const MissileData MissilesData[] = {
	...
	/*Phasing*/ { &AddPhasing, &ProcessTeleport, LS_TELEPORT, SFX_NONE, MissileGraphicID::None, Physical | Invisible, MissileMovementDistribution::Blockable },
	...
	/*FlashBottom*/ { &AddFlashBottom, &ProcessFlashBottom, LS_NOVA, LS_ELECIMP1, MissileGraphicID::FlashBottom, Magic, MissileMovementDistribution::Unblockable },
	/*FlashTop*/ { &AddFlashTop, &ProcessFlashTop, SFX_NONE, SFX_NONE, MissileGraphicID::FlashTop, Magic, MissileMovementDistribution::Unblockable },
	...
	/*DoomSerpents*/ { &AddChainStatic, &ProcessChainStatic, LS_DSERP, SFX_NONE, MissileGraphicID::Lightning, Lightning, MissileMovementDistribution::Disabled },
	...
	/*BloodRitual*/ { &AddBola, &ProcessGenericProjectile, /* &ProcessBola,*/ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Unblockable },
	/*Invisibility*/ { &AddInvis, &ProcessGenericProjectile, /* &AImedShot,*/ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Unblockable },
	/*Golem*/ { &AddGolem, nullptr, LS_GOLUM, SFX_NONE, MissileGraphicID::None, Physical | Invisible, MissileMovementDistribution::Disabled },
	/*Etherealize*/ { &AddRedPortal, &ProcessEtherShield, LS_SENTINEL, LS_ELEMENTL, MissileGraphicID::RedPortal, Magic, MissileMovementDistribution::Disabled },
	...
	/*HolyBoltBoom*/ { &AddHolyBoltBoom, &ProcessHolyBoltBoom, SFX_NONE, SFX_NONE, MissileGraphicID::Resurrect, Physical, MissileMovementDistribution::Disabled },
	...
	/*HolyBolt*/ { &AddHolyBolt, &ProcessHolyBolt, LS_HOLYBOLT, LS_ELECIMP1, MissileGraphicID::Resurrect, Physical, MissileMovementDistribution::Blockable },
	...
	/*HolyBolt*/ { &AddSmite, &ProcessSmite, LS_HOLYBOLT, LS_ELECIMP1, MissileGraphicID::HolyBolt, Physical, MissileMovementDistribution::Blockable },
	...
	/*HolyBoltBow*/ { &AddHolyBolt, &ProcessHolyBolt, LS_HOLYBOLT, LS_ELECIMP1, MissileGraphicID::Resurrect, Physical, MissileMovementDistribution::Blockable },
	...
	/*Holybolt Multi Proc*/ { &AddSearch, /* &AddSearch,*/ &ProcessSearch, SFX_NONE, SFX_NONE, MissileGraphicID::Resurrect, Physical, MissileMovementDistribution::Blockable },
	...
	/*Jester*/ { &AddJester, &ProcessJester, SFX_NONE, SFX_NONE, MissileGraphicID::Inferno, Physical, MissileMovementDistribution::Disabled },
	...
	/*ManaRegen*/ { &AddManaRegen, nullptr, LS_ETHEREAL, SFX_NONE, MissileGraphicID::ManaRegen, Magic | Invisible, MissileMovementDistribution::Disabled },
	/*HealthRegen*/ { &AddHealthRegen, nullptr, LS_ETHEREAL, SFX_NONE, MissileGraphicID::HealthRegen, Magic | Invisible, MissileMovementDistribution::Disabled },
	/*DmgReduct*/ { &AddDmgReduct, nullptr, LS_ETHEREAL, SFX_NONE, MissileGraphicID::DmgReduct, Magic | Invisible, MissileMovementDistribution::Disabled },
	/*WitchBS*/ { &AddWitchBS, &ProcessGenericProjectile, /*&ProcessTeleport,  */ LS_TELEPORT, SFX_NONE, MissileGraphicID::BloodStar, Magic, MissileMovementDistribution::Disabled },
	/*SplitA*/ { &AddSplitA, &ProcessGenericProjectile, /*&ProcessTeleport,  */ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Disabled },
	/*QuickS*/ { &AddQuickS, &ProcessGenericProjectile, /*&ProcessTeleport,  */ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Disabled },
	/*Cleave*/ { &AddCleave, &ProcessGenericProjectile, /*&ProcessTeleport,  */ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Disabled },
	/*Strike*/ { &AddStrike, &ProcessGenericProjectile, /*&ProcessTeleport,  */ SFX_NONE, SFX_NONE, MissileGraphicID::Arrow, Physical, MissileMovementDistribution::Disabled },
	/*Strike*/ { &AddBloodM, &ProcessGenericProjectile, /*&ProcessTeleport,  */ SFX_NONE, SFX_NONE, MissileGraphicID::BloodStarExplosion, Magic, MissileMovementDistribution::Disabled },
	// clang-format on
};
...
/*TownPortal*/ /*Etheralize*/          { {},               96,          16, "rportal",           2, MissileGraphicsFlags::None,                     3, AnimLen_16      },
/*Etherealize*/         //     { {},               96,          16, "hlthregn",                 1, MissileGraphicsFlags::None,                     0, AnimLen_10       },
...
/*ManaRegen,*/               { {},               96,          16, "manaregn",         1, MissileGraphicsFlags::NotAnimated,              0, AnimLen_1       },
/*HealthRegen,*/               { {},               96,          16, "hlthregn",         1, MissileGraphicsFlags::NotAnimated,              0, AnimLen_1       },
/*DmgReduct,*/               { {},               96,          16, "dmgrduct",         1, MissileGraphicsFlags::NotAnimated,              0, AnimLen_1       },
/* WitchBS,*/                { {},              128,          32, "flare",            1, MissileGraphicsFlags::None,                     0, AnimLen_16      },
/* SplitA,*/                    { {},               96,          16, "arrows",           1, MissileGraphicsFlags::NotAnimated,              0, AnimLen_16      },
/* QuickS,*/                { {},              128,          32, "flareb",            1, MissileGraphicsFlags::None,                     0, AnimLen_16      },
/*Cleave,*/                 { {},               96,          16, {},                 4, MissileGraphicsFlags::None,                     0, AnimLen_15      },
/* Strike,*/                 { {},               96,          16, {},                 4, MissileGraphicsFlags::None,                     0, AnimLen_15      },
/*BloodM,*/                 { {},               96,          16, {},                 4, MissileGraphicsFlags::None,                     0, AnimLen_15      },
/*QuickSxpl,*/       { {},              128,          32, "flarexpb",         1, MissileGraphicsFlags::None,                     0, AnimLen_7       },
/*BloodStarExplosion*/     //  { {},              128,          32, "flarexpb",         1, MissileGraphicsFlags::None,                     0, AnimLen_7       },
/*BloodStarExplosion*/    //   { {},              128,          32, "flarexpb",         1, MissileGraphicsFlags::None,                     0, AnimLen_7       },
